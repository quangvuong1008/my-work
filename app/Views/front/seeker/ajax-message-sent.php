    ...
    <?php if ($messData && !empty($messData)) : ?>
        <?php foreach ($messData as $key => $md) : ?>
            <div class="tablehs-01-row message-page__item row align-items-center mx-1 mx-md-0">
                <div class="tablehs-01-row-td d-flex align-items-center message-page__col-information" onclick="showModalSeekerMess('<?= $md->id ?>', -1)">
                    ...
                    <div class="col-12 px-1 px-md-3 col-md-10 message-page__col-information-title" style="padding-left: 1rem!important; padding-right: 1rem!important;">
                        ...
                        <div class="info-user mt-1"><i class="far fa-user" style="font-size: 13px; margin-right: 3px;"></i><span class="font500 align-middle">Gửi bởi: <?= $md->fullname ?></span></div>
                    </div>
                </div>
                <div class=" tablehs-01-row-td message-page__col-created pl-0-mb" onclick="showModalSeekerMess('<?= $md->id ?>', -1)">
                ...
                <div class="tablehs-01-row-td message-page__col-action align-items-center d-none d-md-flex hidden-xs">
                    <button class="btn btn-info mr-2" type="button" onclick="showModalSeekerMess('<?= $md->id ?>', -1)"><i class="far fa-eye"></i>
                    </button>
