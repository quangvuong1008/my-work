                            ...
                            <div class="tabbox-01 tab-pane fade in active show">
                                <div class="tabbox-01-cont">
                                    <div class="tabbox-01-form">
                                        <div class="tabbox-01-ttl">Nhà tuyển dụng đăng nhập</div>
                                        <div class="tabbox-01-block">
                                            <form  action="<?= base_url().'/UserRecruitment/user_login'?>" method="post" class="form-hook">
                                                <div class="">
                                                    <div>
                                    ...
                                    <p class=""> Bạn chưa có tài khoản?
                                        <a class="active mx-1"
                                           href="/nha-tuyen-dung/dang-ky">Tạo
                                            tài khoản</a></p>
                                    <p><a class="hidden-xs" href="/dang-nhap">Người tìm việc đăng nhập</a></p></div>
                            </div>
                        </div>
                    </div>
                </div>
