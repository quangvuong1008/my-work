                    ...
                    <form>
                        <div class="jsx-1543968621 search-01-bg fn-search-bg-tran">
                            ...
                            <div class="jsx-1543968621 search-01-row row">
                                <div class="jsx-1543968621 div-input"><input type="text" name="q" id="input-keyword" placeholder="Nhập tên công việc, vị trí, kỹ năng..." class="jsx-1543968621 form-control"></div>
                                <div class="jsx-1543968621 div-sl-tk ex-sl-nn">
                                    <select class="selectpicker form-control" name="scales" id="scales" data-live-search="true">
                                ...
                                <div class="jsx-1543968621 div-btn">
                                    ...
                                    <i class="fas fa-search-minus fs-24 text-speci"></i><span class="jsx-1543968621 text-speci font500">Tìm kiếm nâng cao</span>
                                </a> -->
                                </div>
                            </div>
                        </div>
        ...
        <div class="jsx-1543968621 banner-01-btns mt20 m-mt15">
            <div class="jsx-1543968621 container">
                <div class="jsx-1543968621 row group-button-search-01">
                    <div class="jsx-1543968621 col-12 col-sm-6 col-md-6 col-lg-6 txr"><a class="jsx-1543968621 btn btn-blue-50 w285" href="/tao-ho-so-online">Bảng báo phí dịch vụ</a>
                    </div>
                    <div class="jsx-1543968621 col-12 col-sm-6 col-md-6 col-lg-6"><a class="jsx-1543968621 btn btn-pink-50 w285" href="/trang-ca-nhan/quan-ly-ho-so">Đăng tin</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <?php foreach ($new_rcm as $nrcm) : ?>
                        ...
                        <li class="col-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="jobblock-01-box">
                                <div class="jobblock-01-row"><a href="<?= $nrcm->getSeekerUrl() ?>">
                                        <figure>
                                            <img src="<?= $getUrl ?>" alt="truong-phong-kinh-doanh">
                                        </figure>
                                    </a>
                                    <div class="jobblock-01-ttl">
                                        <a title="<?= $nrcm->title ?>" class="jobblock-01-ttl-light text-ellipsis" href="<?= $nrcm->getSeekerUrl() ?>">
            ...
            <ul class="row">
                <?php if ($rcm_interesting) : ?>
                    <?php foreach ($rcm_interesting as $rcm_int) : ?>
                        ...
                        <li class="col-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="jobblock-01-box">
                                <div class="jobblock-01-row"><a href="<?= $rcm_int->getSeekerUrl() ?>">
                                        <figure>
                                            <img src="<?= $getUrl ?>" alt="truong-phong-kinh-doanh">
                                        </figure>
                                    </a>
                                    <div class="jobblock-01-ttl">
                                        <a title="<?= $rcm_int->title ?>" class="jobblock-01-ttl-light text-ellipsis" href="<?= $rcm_int->getSeekerUrl() ?>">
            ...
            <ul class="row">
                <?php if ($rcm_high_salary) : ?>
                    <?php foreach ($rcm_high_salary as $rcm_hsr) : ?>
                        ...
                        <li class="col-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="jobblock-01-box">
                                <div class="jobblock-01-row"><a href="<?= $rcm_hsr->getSeekerUrl() ?>">
                                        <figure>
                                            <img src="<?= $getUrl ?>" alt="truong-phong-kinh-doanh">
                                        </figure>
                                    </a>
                                    <div class="jobblock-01-ttl">
                                        <a title="<?= $rcm_hsr->title ?>" class="jobblock-01-ttl-light text-ellipsis" href="<?= $rcm_hsr->getSeekerUrl() ?>">
