    ...
    <article>
        <div class="cont-970-dky">
                    ...
                    <li class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="box-lst-01-box">
                            ...
                            <div class="box-lst-01-cont"><i class="icon-dky-01"></i>
                                ...
                                <a class="btn btn-dky btn-ntv-dky" href="/dang-ky">Người tìm việc đăng ký</a></div>
                        </div>
                    </li>
                    <li class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="box-lst-01-box">
                            ...
                            <div class="box-lst-01-cont"><i class="icon-dky-02"></i>
                                ...
                                <a class="btn btn-dky btn-ntd-dky" href="/nha-tuyen-dung/dang-ky">Nhà tuyển dụng đăng
                                    ký</a></div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="txt-btm-01">
                <div class="txt-btm-01-dn">Bạn đã có tài khoản?<a class="mx-1" href="/auth/login">Đăng ký miễn phí</a></div>
