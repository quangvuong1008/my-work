 ...
 * @var \App\Models\PartnerModel[] $models
 * @var \CodeIgniter\Pager\Pager $pager
 */

$this->title = 'Quản lý Đối tác viết bài';
?>
<div class="card">
    <div class="card-header card-header-info flex-align">
        ...
        <a href="<?= route_to('admin_partner_create') ?>" class="btn btn-warning btn-round">Thêm mới</a>
    </div>
                    ...
                    <td colspan="100">
                        <div class="empty-block">
                            ...
                            <a class="btn btn-info btn-round"
                               href="<?= route_to('admin_partner_create') ?>">Thêm</a>
                        </div>
                    </td>
                </tr>
            <?php else: ?>
                <?php foreach ($models as $model): ?>
                    <tr>
                        ...
                        <td class="row-actions">
                            <a href="<?= route_to('admin_partner_update', $model->getPrimaryKey()) ?>"
                               class="btn btn-info btn-just-icon">
                                <i class="material-icons">edit</i>
                            </a>
                            <a href="<?= route_to('admin_partner_delete', $model->getPrimaryKey()) ?>"
