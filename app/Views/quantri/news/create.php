...
<div class="card">
    <div class="card-header card-header-success flex-align">
        ...
        <a href="<?= route_to('admin_news') ?>" class="btn btn-round">Huỷ</a>
    </div>
    <div class="card-body">
        <form action="<?= route_to('admin_news_create') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-bottom-actions">
                ...
                <a class="btn btn-outline-light btn-round" data-method="get"
                   ...
                   href="<?= route_to('admin_project_news') ?>">Huỷ
                </a>
