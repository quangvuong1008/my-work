 ...
 */
$this->title = 'Tạo mới lĩnh vực hoạt động';
?>
<div class="card">
    <div class="card-header card-header-success flex-align">
        ...
        <a href="<?= route_to('admin_fields_of_operation') ?>" class="btn btn-round">Huỷ</a>
    </div>
    <div class="card-body">
        <form action="<?= route_to('admin_fields_of_operation_create') ?>" method="post" enctype="multipart/form-data">
