...
<div class="card">
    <div class="card-header card-header-info flex-align">
        ...
        <a href="<?= route_to('admin_project_create') ?>" class="btn btn-warning btn-round">Thêm mới</a>
    </div>
                    ...
                    <td colspan="100">
                        <div class="empty-block">
                            ...
                            <a class="btn btn-info btn-round"
                               href="<?= route_to('admin_project_create') ?>">Thêm</a>
                        </div>
                    </td>
                </tr>
            <?php else: ?>
                <?php foreach ($models as $model): ?>
                    <tr>
                        ...
                        <td class="row-actions">
                            ...
                            <?= Html::a('<i class="material-icons">edit</i>', ['admin_project_update', $model->getPrimaryKey()], [
                                'class' => ['btn', 'btn-info', 'btn-just-icon'],
                                'title' => 'Sửa'
                            ]) ?>
                            <a href="<?= route_to('admin_project_delete', $model->getPrimaryKey()) ?>"
