 ...
 */
$this->title = 'Cập nhật Danh mục sản phẩm';
?>
<div class="card">
    <div class="card-header card-header-info flex-align">
        ...
        <a href="<?= route_to('admin_product_category') ?>" data-method="get"
    ...
    <div class="card-body">
        <form action="<?= route_to('admin_product_category_update', $model->getPrimaryKey()) ?>" method="post"
