...
$this->title = 'Quản lý Danh sách ứng viên';
?>
<div class="card">
                    ...
                    <?php foreach ($models as $model) : ?>
                        <tr>
                            ...
                            <td class="row-actions">
                                <a href="<?= route_to('admin_user_seeker_view', $model->getPrimaryKey()) ?>" class="btn btn-warning btn-just-icon">
                                    <i class="material-icons">remove_red_eye</i>
                                </a>
                                <a href="<?= route_to('admin_user_seeker_delete', $model->getPrimaryKey()) ?>" class="btn btn-danger btn-just-icon" data-method="post" data-prompt="Bạn có chắc sẽ xoá đi mục này?">
